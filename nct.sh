...
echo $cyan" ["$red"+"$cyan"]Author by	: J@V@ R10T "
echo $cyan" ["$red"+"$cyan"]Team        : Next Cyber Team		"
echo $cyan" ["$red"+"$cyan"]Blog        : http://officialnct.zone.id"
echo $cyan" ["$red"+"$cyan"]Github	: https://github.com/Javariot15"
echo $purple"___________________________________________________"
...
echo $red"	~"$cyan"{"$white"3"$cyan"}"$white".Mode Banyak"$cyan
echo $purple"___________________________________________________"
echo $red"	~"$cyan"{"$white"T"$cyan"}"$white".TUTORIAL"$cyan
echo $purple"___________________________________________________"
echo $white "╭─"$green"JAVA@localhost"$cyan" ~/NCTsystem"$white
read -p " ╰─$ "  apaan
...
echo $green "taroh script di luar folder internal"
echo $white "╭─"$green"JAVA@localhost"$cyan" ~/NCTsystem"$white
read -p " ╰─$ "  script
...
echo $white "| |\  | |___  | |"
echo $white "|_| \_|\____| |_|"
echo $yellow Mulai Nyolong
echo $green "Mana Target !!!! "
echo $white "╭─"$green"JAVA@localhost"$cyan" ~/NCTsystem"$white
read -p " ╰─$ "  target
echo $green "Masukan nama script??(ex: script.html)"
echo $white "╭─"$green"JAVA@localhost"$cyan" ~/NCTsystem"$white
read -p " ╰─$ " simpan
...
echo $white "| |\  | |___  | |"
echo $white "|_| \_|\____| |_|"
figlet -f smshadow "MASAL"
echo "### ctrl + c to quit ###"
echo $red "Maksimal deface 20 terget"
echo "Masukan Script !!!!"
echo $white "╭─"$green"JAVA@localhost"$cyan" ~/NCTsystem"$white                               
read -p " ╰─$ " script
...
echo $green"AUTHOR : j@V@ R10T			"
echo $purple"GITHUB : https://github.com/Javariot15"
echo $white"BLOG 1: https://officialnct.zone.id"
echo $white"BLOG 2: https://officialnct.blogspot.com"
echo $yellow"		  THANKS TO : "
echo $cyan"[+] Next Cyber Team "
echo $cyan"[+] Next Jaks "
echo $cyan"[+] All Member NCT "
echo $red"################# INFO ####################"
echo $indigo"__________________________________________"
echo $cyan"["$yellow"B"$cyan"]"$white"back "$cyan"["$yellow"Q"$cyan"]"$white"Quit"
read -p "[B/Q] " back
